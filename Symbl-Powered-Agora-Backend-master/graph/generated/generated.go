...
type ComplexityRoot struct {
	...
	UserCredentials struct {
		...
		Symt         func(childComplexity int) int
		SymblTExpire func(childComplexity int) int
	}
}
...
type QueryResolver interface {
	JoinChannel(ctx context.Context, passphrase string) (*model.Session, error)
	Share(ctx context.Context, passphrase string) (*model.ShareResponse, error)
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "UserCredentials.symt":
		if e.complexity.UserCredentials.Symt == nil {
			break
		}

		return e.complexity.UserCredentials.Symt(childComplexity), true

	case "UserCredentials.symblTExpire":
		if e.complexity.UserCredentials.SymblTExpire == nil {
			break
		}

		return e.complexity.UserCredentials.SymblTExpire(childComplexity), true
...
func (ec *executionContext) _UserCredentials_symt(ctx context.Context, field graphql.CollectedField, obj *model.UserCredentials) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _UserCredentials_sexp(ctx context.Context, field graphql.CollectedField, obj *model.UserCredentials) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
	...
	res := resTmp.(float64)
	fc.Result = res
	return ec.marshalNString2string(ctx, field.Selections, fmt.Sprint(res))
}
...
func (ec *executionContext) _UserCredentials(ctx context.Context, sel ast.SelectionSet, obj *model.UserCredentials) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "symt":
			out.Values[i] = ec._UserCredentials_symt(ctx, field, obj)
		case "symblTExpire":
			out.Values[i] = ec._UserCredentials_sexp(ctx, field, obj)
		case "uid":
...
func (ec *executionContext) marshalNPassphrase2githubᚗcomᚋsamyakᚑjainᚋagora_backendᚋgraphᚋmodelᚐPassphrase(ctx context.Context, sel ast.SelectionSet, v model.Passphrase) graphql.Marshaler {
	return ec._Passphrase(ctx, sel, &v)
}

func (ec *executionContext) marshalNPassphrase2ᚖgithubᚗcomᚋsamyakᚑjainᚋagora_backendᚋgraphᚋmodelᚐPassphrase(ctx context.Context, sel ast.SelectionSet, v *model.Passphrase) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
